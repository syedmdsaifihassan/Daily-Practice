...
public class Main {
   ...
   public static void main(String[] args) throws Exception {
      ...
      func(graph, src, src, new boolean[graph.length], ""+src, 0);
   }
   
   public static void func(ArrayList<Edge>[] graph, int src, int osrc, boolean[] visited, String asf, int vvsf){
       ...
       // aate waqt visited mark krenge
       visited[src] = true;
       for(Edge e: graph[src]){
           int nbr = e.nbr;
           if(visited[nbr]==false){
               func(graph, nbr, osrc, visited, asf+nbr, vvsf+1);
           }
       }
       // jate waqt unvisited mark krenge
       visited[src] = false;
   }
